...
// Importamos solo el tipo, que ahora incluye las propiedades de PAGINACIÓN
import type { DynamicFormContextData } from './interface'; // Asegúrate que la ruta sea correcta
