...
const AddEditEmployContent: React.FC<{
        ...
        if (employ) {
                ...
                if (initialString === currentString) {
                        ...
                        // Si no hay cambios, se cierra el formulario sin llamar a la API
                        return onClose(); 
                }
                
                // Si hay cambios, el codigo continua y llama a onSave
        }
        ...
        }, [employ, onSave, onClose, initialData]); // 🛑 CRÍTICO: Añadir initialData y onClose a las dependencias
