...
// 💡 2. Importar el tipo CardManagerContextType desde su archivo de TIPOS
// (Subir dos niveles, entrar a CardContainer/types)
 ...
 */
export const useCardManager = (): CardManagerContextType => {
  ...
  return context as CardManagerContextType;
};